<?php
  ...
  $codigoCartao = $_GET["codigoCartao"];
  ...
  $retorno = $factory->getObjeto("funcionario")->editarFuncionario($idFuncionario, $nomeFuncionario, $nascimentoFuncionario, $codigoCartao);
