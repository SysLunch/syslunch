...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Editar Local - Locais CRT - Configurações - <?php echo $nomeSite; ?></title>
...
<div class="row">
  <div class="medium-48 columns">
    <div class="tituloPagina"><?php echo $nomeSite; ?> >> Configurações >> Locais CRT >> Editar Local CRT</div>
  </div>
  <div class="medium-48 columns">
    <ul class="menu">
  ...
  <table class="CRTConfigTable">
      <tbody>
          <tr>
            <td>Nome do Local</td>
            <td><input type="text" name="nomeLocal" id="nomeLocal" value="<?php echo $dadosLocal["descricaoLocal"]; ?>" required /></td>
          </tr>
          <tr>
            <td></td>
            <td>
