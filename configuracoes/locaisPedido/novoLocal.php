...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Novo Local - Locais Pedido - Configurações - <?php echo $nomeSite; ?></title>
...
<div class="row">
  <div class="medium-48 columns">
    <div class="tituloPagina"><?php echo $nomeSite; ?> >> Configurações >> Locais Pedido</div>
  </div>
  <div class="medium-48 columns">
    <ul class="menu">
  ...
  <div class="medium-48 columns centers displayNone" id="avisoSucesso">
    <div class="callout success">
      <h5>SUCESSO!</h5>
      <p>Cadastro do local <b></b> realizado com sucesso!</p>
    </div>
  </div>
